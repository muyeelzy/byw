		...
		/**
		 * 根据2015年8月26日最新银行利率：公积金[5年以下：2.75%（包括5年），5年以上：3.25%]；
		 * 商业贷款[0~1年：4.60%（包括1年），1~5年：5.00%（包括5年），5年以上：5.15%]
		 * @type {number}
		 */
		...
		var bizRate_discount_lt1 = '4.60'; //商业贷款<=1年基准利率
		var bizRate_discount_gt1lt5 = '5.00'; //商业贷款>1年<=5年基准利率
		var bizRate_discount_gt5 = 5.15; //商业贷款>5年基准利率
		var bizRate_discount_part2_lt1 = 5.06; //商业贷款<=1年第二套房利率
		var bizRate_discount_part2_gt1lt5 = '5.50'; //商业贷款>1年<=5年第二套房利率
		var bizRate_discount_part2_gt5 = 5.67; //商业贷款>5年第二套房利率
		...
		$(function() {
			...
			//计算方式-根据贷款总额
			$("#caltype1").click(function() {
				$("#gjjRateIntroduction").css({
					top: "268px",
					left: "425.5px"
				});
				$("#resultIntroduction").css({
					top: "303px"
				});
			...
			$("#loantype1").click(function() {
				...
				$("#totalCapital span:first").html('').html("贷款总额");
				$("#totalCapital span:eq(1)").css({
					display: "none"
				});
				$("#gjjCapital span:eq(2)").css({
					display: "none"
				});
				$("#bizCapital span:eq(1)").css({
					display: "none"
				});
				$("#capitalPercent").css({
					display: "none"
				...
				$("#discount span:gt(0)").css({
					display: "none"
				});
			});
			//贷款类别-商业贷款
			$("#loantype2").click(function() {
				rateDisplay();
				initValidateValue();
				$("#resultIntroduction").css({
					top: "303px"
			...
			//基准利率
			$("#discount input:first").click(function() {
				rateDisplay();
				//获取当前的贷款类别
			...
			//首套优惠85折
			$("#discount input:eq(1)").click(function() {
				rateDisplay();
				//获取当前的贷款类别
				var loantype = $("input[name='loantype']:checked").val();
				var loanTime = $("#loanTime").val();
			...
			//首套优惠95折
			$("#discount input:eq(2)").click(function() {
				rateDisplay();
				//获取当前的贷款类别
				var loantype = $("input[name='loantype']:checked").val();
				var loanTime = $("#loanTime").val();
			...
			//第二套房利率
			$("#discount-part2 input:first").click(function() {
				rateDisplay();
				//获取当前的贷款类别
				var loantype = $("input[name='loantype']:checked").val();
				var loanTime = $("#loanTime").val();
			...
			$("#totalCapital input:first").blur(function() {
			...
			$("#gjjCapital input:first").blur(function() {
			...
			$("#bizCapital input:first").blur(function() {
			...
			$("#gjjRate input:first").blur(function() {
				var gjjRate = $("#gjjRate input:first").val(); //利率
				if(gjjRate == '') { //利率不能为空

					$("#gjjRate span:eq(2)").css({
						display: "none"
					});
					$("#gjjRate span:eq(3)").css({
						display: "none"
					});
					$("#gjjRate span:eq(4)").css({
						display: "inline"
					});
			...
			$("#bizRate input:first").blur(function() {

				var bizRate = $("#bizRate input:first").val(); //商贷利率
				if(bizRate == '') { //利率不能为空
					$("#bizRate span:eq(2)").css({
						display: "none"
					});
					$("#bizRate span:eq(3)").css({
						display: "none"
					});
					$("#bizRate span:eq(4)").css({
						display: "inline"
					});
			...
			//还款方式介绍
			$("#repaytype-tips").mouseover(function() {

				$("#repayTypeIntroduction").css({
					display: "block"
				});

			});
			$("#repaytype-tips").mouseout(function() {
			...
			//计算结果介绍
			$("#result-help").mouseover(function() {
