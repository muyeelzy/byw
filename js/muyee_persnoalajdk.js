...
function houseLoanCalc(flag)
{
	...
	if(!IsIntYear($('#year'), '', "\u8d37\u6b3e\u5e74\u9650")) return false;
		...
		if(!IsIntAmount(document.calcform.com_rate.value, '3', "\u5546\u4e1a\u8d37\u6b3e\u5229\u7387")) return false;
...
function portfolioLoanCalc()
{
	...
	var g	=	$F('com_rate')/1200;	
	//dai kuan yue li lv
	var h	=	$F('fund_rate')/1200;	
	//dai kuan yue li lv
	if(a*b<f+i)
	{
	...
	else
	{
		...
		template='<table class="second_list_table second_list_position"><tr><td colspan="5" class="text_center">\u8fd8\u6b3e\u660e\u7ec6</td></tr><tr><th>'+'\u671f\u6b21'+'</th><th>'+'\u5546\u8d37\u5f53\u671f\u6708\u4f9b'+'</th><th>'+'\u516c\u79ef\u91d1\u5f53\u671f\u6708\u4f9b'+'</th><th>'+'\u5408\u8ba1'+'</th><th>'+'\u5269\u4f59\u672c\u91d1'+'</th></tr>';
		for (k=1; k<=e; k++)
		{
			com_sum +=  (f-com_x)*g;
			com_y = f/e + (f-com_x)*g;
...
function BalloonLoanCalc()
{
	...
	template='<table class="second_list_table second_list_position"><tr><td colspan="5" class="text_center">\u8fd8\u6b3e\u660e\u7ec6</td></tr><tr><th>'+'\u671f\u6b21'+'</th><th>'+'\u507f\u8fd8\u5229\u606f'+'</th><th>'+'\u507f\u8fd8\u672c\u91d1'+'</th><th>'+'\u8fd8\u6b3e\u989d'+'</th><th>'+'\u5269\u4f59\u672c\u91d1'+'</th></tr>';
	for (i=1; i<=term-1; i++)
	{
		m = (a-sum)*r/12;
...
function providentFundLoanCalc()
{
	...
	personal_ratio		=	parseFloat($F('personal_ratio')/100);	
	//ben ren yue jiao bi li
	spouses_deposits	=	$('spouses_deposits').value; //pei ou yue jiao cun e 
	spouses_ratio		=	parseFloat($F('spouses_ratio')/100);	
	//pei ou yue jiao cun bi li 
...
{
	//var GetPerYearRateUrl = '//www.bankrate.com.cn/calc/getPerYearRate';
